...
<body class="flex flex-row min-h-screen bg-white dark:bg-zinc-800" x-data="{show:true}">
    <div class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        <flux:icon.list-bullet class="block m-4 lg:hidden" @click="show=!show" />
...
-->
    ...
    <flux:header class="lg:hidden">
        <flux:sidebar.toggle
            @click="$dispatch('toggle-sidebar', { id: 'main-sidebar' })"
            class="lg:hidden" icon="bars-2" inset="left" />
