...
<body class="flex min-h-screen text-right bg-white dark:bg-zinc-800" x-data="{ show: false }">
    <!-- Sidebar -->
    <aside class="fixed inset-y-0 left-0 z-30 hidden w-64 h-screen overflow-y-auto transition-all duration-300 ease-in-out  border-e border-zinc-200 dark:border-zinc-700 lg:relative lg:block" :class="{ 'block': show, 'hidden': !show }">
        <div class="p-4">
